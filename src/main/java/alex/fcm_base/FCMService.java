...
//    }
//
//    //отправить push-уведомление в тему, используя образцы данных
...
//    }
    ...
    //отправка запланированного образца push-уведомления в тему (каждую минуту)
    private String sendAndGetResponse(Message message) throws InterruptedException, ExecutionException {
        return FirebaseMessaging.getInstance().sendAsync(message).get();
    }

    //отправить push-уведомление с дополнительной полезной нагрузкой (определяемый пользователем объект данных типа ключ / значение
    ...
    //отправить push-уведомление без дополнительных данных
